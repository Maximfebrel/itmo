...
def hand_method():
    ...
    print(f"f1 hand method: {f1_score(y_test, y_pred,  average='macro'):.4f}")
...
def tree_method():
    ...
    print(f"f1 tree precession: {f1_score(y_test, y_pred_tree, average='macro'):.4f}")
...
def sklearn_method():
    ...
    print(f"Sklearn f1: {f1_score(y_test, y_pred_model, average='macro'):.4f}")
